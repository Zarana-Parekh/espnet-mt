...
# The howto 90hr train/utt2spk was failing this test. Commenting after prelimimary manual checks
#utils/validate_data_dir.sh --no-spk-sort --no-text --no-feats $data || exit 1;
