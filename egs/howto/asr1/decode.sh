...
# to run:
: <<'END'
expath=exp/480h/train_word_blstmp_e6_subsample1_2_2_1_1_unit320_proj320_ctcchainer_d1_unit300_location_aconvc10_aconvf100_mtlalpha0_adadelta_bs48_mli800_mlo150_initchar_lsmunigram0.05

./decode.sh --ctc_weight 0 --beam_size 20 --penalty 0.1 --expdir $expath --target word --datadir data/480h --dumpdir /tmp/spalaska/howto_data_480h --dump_h False
END
 . ./path.sh
 . ./cmd.sh
